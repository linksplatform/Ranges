...
// This demonstrates the Range library in action and helps verify our test coverage
class TestCoverageVerification
{
    static void Main()
    {
        ...
        Console.WriteLine($"Range.Int32: {Range.Int32}");
        Console.WriteLine($"Range.Byte: {Range.Byte}");
